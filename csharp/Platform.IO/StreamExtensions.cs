...
namespace Platform.IO
{
    ...
    public static class StreamExtensions
    {
        ...
        /// <para>Записывает последовательность байт представляющую структуру <paramref name="value"/> типа <typeparamref name="T"/> в поток <paramref name="stream"/> и перемещает текущую позицию в <paramref name="stream"/> вперёд на число записанных байт.</para>
        /// </summary>
        /// <typeparam name="T">
        ...
        /// </param>
        /// <param name="value">
        /// <para>The <typeparamref name="T"/> structure value to be written to the <paramref name="stream"/>.</para>
        /// <para>Значение структуры типа <typeparamref name="T"/> которое будет записано в поток <paramref name="stream"/>.</para>
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// <para>The <typeparamref name="T"/> structure value, if its bytes from the <paramref name="stream"/> are read; otherwise the default <typeparamref name="T"/> structure value.</para>
        /// <para>Значение структуры типа <typeparamref name="T"/>, если её байты из потока <paramref name="stream"/> были прочитаны, иначе значение структуры типа <typeparamref name="T"/> по умолчанию.</para>
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// <para>Reads and returns all <typeparamref name="T"/> structure values array from the <paramref name="stream"/>.</para>
        /// <para>Прочитывает и возвращает массив всех значений структур типа <typeparamref name="T"/> из потока <paramref name="stream"/>.</para>
        /// </summary>
        /// <typeparam name="T">
        /// <para>The structure type.</para>
        /// <para>Тип структуры.</para>
        ...
        /// </param>
        /// <returns>
        /// <para>The <typeparamref name="T"/> structure values array read from the <paramref name="stream"/>.</para>
        /// <para>Массив с значениями структур типа <typeparamref name="T"/>, прочитанными из потока <paramref name="stream"/>.</para>
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
